<%-- Document : Dashboard Created on : Feb 10, 2025, 10:05:41 AM Author : nhutt --%>
...
<html lang="vi">
    <head>
        ...
        <style>
            ...
            .avatar-btn:hover { color: #e9ecef; }
            .dropdown-menu .dropdown-item:hover { cursor: pointer; }
            .dropdown-menu .dropdown-item:active { background-color: #e9ecef !important; }
        </style>
    </head>
    ...
    <body>
            ...
            <div class="container">
                ...
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                        <li>
                            <p class="dropdown-item text-danger" data-bs-toggle="modal" data-bs-target="#profileModal">
                                Edit Profile
                            </p>
                        </li>
        ...
        <header class="bg-danger text-white py-5 text-center d-flex align-items-center justify-content-center"
                style="background-image: linear-gradient(to bottom, rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.8)), url('<%=request.getContextPath()%>/images/banner.jpg'); 
        ...
        <footer class="bg-dark text-white py-4 text-center">
            <p>© 2025 Dịch Vụ Ô Tô. Bảo Lưu Mọi Quyền.</p>
        </footer>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="Controller?action=ChangeProfileUser" method="POST">
                            <div class="mb-3">
                                <label for="id" class="form-label">ID</label>
                                <input type="text" class="form-control" id="id" name="id" 
                                       value="${sessionScope.user.custID}" disabled>
                                <input type="hidden" name="id" value="${sessionScope.user.custID}">
                            </div>
                            <div class="mb-3">
                                <label for="name" class="form-label">Name</label>
                                <input type="text" class="form-control" id="name" name="name" 
                                       value="${sessionScope.user.custName}" required>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <div>
                                    <input type="radio" id="male" name="sex" value="M" 
                                           <c:if test="${sessionScope.user.sex == 'M'}">checked</c:if>>
                                           <label for="male">Male</label>
                                           <input type="radio" id="female" name="sex" value="F" 
                                           <c:if test="${sessionScope.user.sex == 'F'}">checked</c:if>>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="address" name="address" 
                                           value="${sessionScope.user.custAddress}" required>
                            </div>
                            <div class="d-grid">
                                <button type="submit" class="btn btn-danger" name="action" value="ChangeProfileUser">
                                    Save Changes 
                                </button>
                            </div>
                        </form>
        ...
        <script>
            document.addEventListener("DOMContentLoaded", function () {
                let message = "${not empty requestScope.messageUpdated ? requestScope.messageUpdated : ''}";
                if (message.trim() !== "") {
                    alert(message);
                }
            });
