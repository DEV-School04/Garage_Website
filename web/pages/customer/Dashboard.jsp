...
<html lang="vi">
    ...
    <body>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="./Controller?action=Invoices"
                               >Hóa Đơn</a
                            >
                        </li>
                    </ul>
                ...
                <div class="dropdown">
                    <button
                        class="avatar-btn dropdown-toggle"
                        type="button"
                        id="avatarDropdown"
        ...
        <!-- Hero Section -->
        <header
            class="bg-danger text-white py-5 text-center d-flex align-items-center justify-content-center"
            style="
                        ...
                        <form action="Controller?action=ChangeProfileUser" method="POST">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="id" name="id"
                                       value="<%= (cust != null) ? cust.getCustID() : ""%>" disabled>
                                <!-- Hidden field to ensure ID is sent -->
                                       <input type="hidden" name="id" value="<%= (cust != null)
                                               ? cust.getCustID() : ""%>">
                            </div>
                            <div class="mb-3">
                                <label for="name" class="form-label">Name</label>
                                <input type="text" class="form-control" id="name" name="name"
                                       value="<%= (cust != null) ? cust.getCustName() : ""%>" required>
                            </div>
                            <div class="mb-3">
                                <label for="phone" class="form-label">Phone</label>
                                <input type="tel" class="form-control" id="phone" name="phone"
                                       value="<%= (cust != null) ? cust.getPhone() : ""%>" required>
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Sex</label>
                                <div>
                                    <input type="radio" id="male" name="sex" value="M" <%= (cust
                                            != null && "M".equalsIgnoreCase(cust.getSex())) ? "checked"
                                            : ""%>>
                                    <label for="male">Male</label>

                                    <input type="radio" id="female" name="sex" value="F" <%= (cust
                                            != null && "F".equalsIgnoreCase(cust.getSex())) ? "checked"
                                            : ""%>>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="address"
                                       name="address" value="<%= (cust != null) ? cust.getCustAddress()
                                               : ""%>" required>
                            </div>
                            <div class="d-grid">
                                <button
        ...
        <script>
            ...
            <% if (request.getAttribute("messageUpdated") != null) {
                    request.removeAttribute("messageUpdated");
                }%>
                if (message.trim() !== "")
                    alert(message);
